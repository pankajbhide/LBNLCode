/*****************************************************************************
 PROGRAM NAME           : GEN_STGPROJFEEDER.SQL 
 ...
 PURPOSE                : INTERFACE PROGRAM TO INSERT STORES TRANSACTIONS 
                          INTO BATCH_MAXIMO.LBL_PROJECT_FEEDERS TABLE (ONCE A 
                          MONTH) FOR PROJECT FEEDER
...
BEGIN
    ...
    RETURN_T :=LBL_MXPSIFACE_PKG.generate_stores_proj_feeder(
    ORGID_T, SITEID_T);
