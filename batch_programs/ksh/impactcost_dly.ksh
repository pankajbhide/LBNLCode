...
# Application  : Maximo
#                Import actuals dollars from DW to MAXIMO  (Preliminary)
#
# Module Name  : impactcost_dly.ksh
# Schedule     : Daily
#============================================================================
# Maintenance Log:
#============================================================================
...
print '===============================================================================' > joblog
print 'Daily process to bring actual dollars started @' `date`  >> joblog
print '===============================================================================' >> joblog
...
${MAX_META_CONTENT}
    ...
    set serveroutput on
    spool actuals
    start $MXES_SITE_HOME/sql/impactcost_dly.sql $ORGID $SITEID
    spool off
    exit sql.sqlcode
SQL_END2
...
rm -f actuals.lst
mv joblog $MXES_SITE_HOME/log/impactcost_dly.log.$FILESUF
